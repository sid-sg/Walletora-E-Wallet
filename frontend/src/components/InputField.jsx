...
const InputField = ({ type, label, placeholder, value, onChange, error }) => {
  ...
  return <div className='mb-2'>
    ...
    <input type={visible ? 'text' : type} placeholder={placeholder} value={value} onChange={onChange} className={`mt-1 w-full p-2.5 bg-gray-800 border ${
